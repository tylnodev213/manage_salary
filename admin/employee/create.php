...
<div class="form-row">
    <div class="form-group col-md-6">
        <label>Họ tên</label>
        <input class="form-control" type="text" id="#hoTen" name="name" id="name">
    </div>
    <div class="form-group col-md-6">
        ...
        <div class="form-row">
        <div class="form-group col-md-6">
        <input type="radio" id="gt" name="gt" value="1">Nam
        </div>
        <div class="form-group col-md-6">
        <input type="radio" id="gt" name="gt" value="0">Nữ
        </div>
        </div>
            </div>
        
        <div class="col-md-6">
        <label>SDT</label> <input class="form-control" type="text" name="phone" id="phone"><br>
        </div>
        Địa chỉ:<input class="form-control" type="text" name="address"><br>
    <div class="row">
        <div class="col-md-6">
        ...
        <?php
            ...
            foreach($result as $each){
                ?>
                <option value="<?php echo $each['id']; ?>"><?php echo $each['tenPhong']; ?></option>
                <?php
            }
        ?>
    </select>
    ...
    Chức vụ: <select class="form-control" name="id_position">
        ...
        <?php
            ...
            foreach($result as $each){
                ?>
                <option value="<?php echo $each['id']; ?>"><?php echo $each['chucVu']; ?></option>
                <?php
            }
        ?>
    </select>
    ...
    <div class="col-md-6">
        <button class="btn btn-primary"onclick="return validate()">Thêm</button>
    </div>
    </div>
</form>
<br>
<h3 style="color:red;font-size:12px" id="error_length" class="title"></h3>
<?php 
$error =$_GET['error'] ?? '';
if($error=='dup'){
