<form class="title" action="department/process_create.php" method="POST">
    Tên phòng: <input type="text" name="name_department" id="name" class="form-control"><br>
    <button class="btn btn-success">Tạo</button>
</form>
<span style="font: size 12px;color:red;" id="error_length"></span>
<span style="font: size 12px;color:red;" id="error_text"></span>
<?php
include '../jQuery.php';
?>
<script>
