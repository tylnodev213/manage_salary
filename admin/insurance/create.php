<form class="title" action="insurance/process_create.php" method="POST">
    Loại bảo hiểm: <input class="form-control" type="text" name="name_insurance" id="name"><br>
    Tiền bảo hiểm(%): <input class="form-control col-md-5" type="number" step="0.01" name="money_insurance">
